...
namespace Backend.Controllers
{
    ...
    public class GEController : ControllerBase
    {
        ...
        {
            return new JsonResult(_context.Group_Expenses.ToList());
        }
        ...
        {
            return new JsonResult(_context.Group_Expenses.Find(id));
        }

        [HttpPost]
        public IActionResult Post(GroupExpense groupExpense)
        {
            _context.Group_Expenses.Add(groupExpense);
        ...
        {
            var IdIzbaze = _context.Group_Expenses.Find(id);
            IdIzbaze.account = groupExpense.account;
            IdIzbaze.expense = groupExpense.expense;

            _context.Group_Expenses.Update(IdIzbaze);
            _context.SaveChanges();
            return new JsonResult(groupExpense);
        }
        ...
        {
            var IdIzBaze = _context.Group_Expenses.Find(id);
            _context.Group_Expenses.Remove(IdIzBaze);
            _context.SaveChanges();
